/*
   ===================================================================================
   TEST QUERY: PRODUCT SALES BY POS - v6.0 (Pre-Agg + Grouping Sets)
   ===================================================================================
   
   Ultimate Optimization:
   1. Pre-Aggregate inside UNION branches (Reduce 100k rows -> 600 rows).
   2. Re-Aggregate in CTE (Merge CY/PY).
   3. Grouping Sets on tiny data for Totals.
   4. Pre-calculated Sort Weights.
   
   This combines ALL previous wins.
   ===================================================================================
*/
