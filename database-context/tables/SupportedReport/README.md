...
**Upcoming changes (Story #3786):**
- `Module` field being removed (replaced by ReportModules many-to-many)
- `Description` field being added (nullable string, displayed via info button)
